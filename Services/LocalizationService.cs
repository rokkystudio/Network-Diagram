...
namespace NetworkDiagram
{
    internal static class LocalizationService
    {
        ...
        private static readonly Dictionary<string, string> EnglishTexts = new Dictionary<string, string>
        {
            ...
            { "tray_icon_style", "Tray icon arrows" },
            { "tray_icon_style_name", "Style {0}" },
            { "theme", "Theme" },
        ...
        private static readonly Dictionary<string, string> RussianTexts = new Dictionary<string, string>
        {
            ...
            { "upload", "Отдача" },
            { "download", "Прием" },
            { "upload_speed", "Скор. отд." },
            { "download_speed", "Скор. пр." },
            { "sent", "Отправлено" },
            { "received", "Получено" },
            { "open", "Открыть" },
            { "settings", "Настройки" },
            ...
            { "tray_icon_style", "Стрелки в трее" },
            { "tray_icon_style_name", "Стиль {0}" },
            { "theme", "Тема" },
